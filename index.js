...
const displayCountryNeighbours = e => {
  e.preventDefault();
...
const renderCountry = (data, className = '') => {
  ...
  <div class="country ${className}">
    ...
    <div class="country__data">
      ...
      <p class="country__row"> <span><i class="fas fa-lg fa-users"></i></span>${(+population / 1_000_000).toFixed(1)}M People</p>
      <p class="country__row"><span><i class="fas fa-lg fa-comments"></i></span>${Object.values(languages)[0]}</p>
      <p class="country__row"><span><i class="fas fa-lg fa-money-bill-wave"></i></span>${Object.values(currencies)[0].name} <strong>${Object.values(currencies)[0].symbol}</strong>
      </p>
    </div>
  </div>
  `;
